  ...
  return (
    <div style={{ padding: "20px", color: "#bfbfbf", transition: "margin-left 0.3s ease", margin: "50px" }}>
      ...
      <p style={{ textAlign: "left" }}>
        ...
        <br></br>
        GoodReads: <a href="https://www.goodreads.com/review/list/149478641-mcnair-bledsoe">Click Here</a>
        <br></br>
        Listning: KidAmNesiac by Radiohead 
        <br></br>
        Watching: nothing atm
        <br></br>
        Coding: Getting AZ 204 Cert, This Website, random Revit addon apps
        <br></br>
        Playing: Everquest Project Quarm, Warhammer: Return of Reckoning, BG3
      </p>
    </div>
  );
};
